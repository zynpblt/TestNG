...
public class C01_Alerts {
    ...
    //Allert ciktiginda sag click yapip incele diyebiliyorsak bu bit HTML alert dir
    //HTML alert ler siradan webelenment ler olarak locate edilip kullanilabilir
